...
public abstract class CompositeGoal : Goal
{
    ...
    protected void ProcessStack()
    {
        ...
        var currentGoal = SubGoalsStack.Peek();
            while (
                SubGoalsStack.Count > 0 && SubGoalsStack.Peek() != null && currentGoal != null && (currentGoal.GoalStatus == GoalStatusType.Completed || currentGoal.GoalStatus == GoalStatusType.Failed))
            {
